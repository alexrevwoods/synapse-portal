...
const portalThemeBackgrounds: Record<string, string> = {
  atlas: "radial-gradient(ellipse 55% 120% at 70% 0%,rgba(86,83,226,.18),transparent 60%)",
  aurora: "radial-gradient(ellipse 55% 120% at 70% 0%,rgba(38,198,180,.22),transparent 60%)",
  nocturne: "radial-gradient(ellipse 55% 120% at 70% 0%,rgba(132,88,255,.24),transparent 60%)",
  ember: "radial-gradient(ellipse 55% 120% at 70% 0%,rgba(238,100,126,.22),transparent 60%)",
};
