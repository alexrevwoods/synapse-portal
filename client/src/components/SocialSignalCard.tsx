...
export type SignalEntry = {
  signal: { id: number; body: string; type: string; visibility: string; publishedAt: Date | string | null };
  profile: Profile;
